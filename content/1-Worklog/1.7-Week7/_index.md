...
| --- | ---- | ---------- | --------------- | ------------------ |
| 2 | - Implement socket connections for real-time data communication between two players <br> - Create room management functions on the backend (`createRoom.js`, `joinRoom.js`); write simple custom room features allowing room code generation and entry for testing | 06/15/2026 | 06/15/2026 | https://cloudjourney.awsstudygroup.com/ |
| 3 | - Redesign the ship placement board UI <br> - Rewrite the board setup screen, adjusting colors, grid boxes, and buttons for a cleaner layout | 06/16/2026 | 06/16/2026 | https://cloudjourney.awsstudygroup.com/ |
| 4 | - Configure matchmaking queues and room division into Casual and Ranked modes <br> - Write backend matchmaking functions (`matchmakeRoom.js`); establish client-side socket connection to queue players into the proper room | 06/17/2026 | 06/17/2026 | https://cloudjourney.awsstudygroup.com/ |
| 5 | - Set up rank points (RP) calculation and define 7 rank tiers: Bronze (200 RP), Silver (500 RP), Gold (950 RP), Platinum (1500 RP), Diamond (2200 RP), Master (3100 RP), Admiral (4000 RP) <br> - Create 7 badge images for each rank; write backend calculation functions (`calculateRankDelta`, `buildRankUpdate`) in `rankService.js`; implement rank-up effects | 06/18/2026 | 06/18/2026 | https://cloudjourney.awsstudygroup.com/ |
| 6 | - Implement rank information list on the profile interface <br> - Create a popup in the Profile page (`Profile.jsx`) for players to view the list of 7 ranks, points requirements, and check their own rank | 06/19/2026 | 06/19/2026 | https://cloudjourney.awsstudygroup.com/ |
| 7 | - Build combat animations using the Phaser library <br> - Write Phaser animations in `BattleEffectsLayer.jsx` for actions: hit (`playMiss`), miss (`playHit`), ship sinking/explosion (`playSunkFinisher`), and the rank-up effect (`RankUpScene`) in `RankUpAnimation.jsx` | 06/20/2026 | 06/21/2026 | https://cloudjourney.awsstudygroup.com/ |
